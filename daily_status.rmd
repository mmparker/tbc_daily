...
If you actually used this, email Matt to have it turned back on!
...
Patients below may be on self-administered therapy
...
names(actives_latest) <- c("TBdb ID", "Last Name", "First Name",
                           "Case Manager", "Tx Plan", "Latest Tx")

dfprintif(actives_latest,
